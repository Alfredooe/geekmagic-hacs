...
class GeekMagicTextEntityDescription(TextEntityDescription):
    ...
    text_type: str = ""  # "screen_name", "slot_entity", "slot_label"
...
class GeekMagicSlotEntityText(GeekMagicTextEntity):
    """Text entity for slot entity_id."""
    ...
    def name(self) -> str:
        ...
        if slot_idx is not None:
            return f"Slot {slot_idx + 1} Entity"
        return "Slot Entity"
...
class GeekMagicSlotLabelText(GeekMagicTextEntity):
    ...
    def name(self) -> str:
        ...
        slot_idx = self.entity_description.slot_index
        if slot_idx is not None:
            return f"Slot {slot_idx + 1} Label"
        return "Slot Label"
